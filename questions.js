...
(() => {
  ...
  const definitions = [
    ...
    { id:'four-cuts', title:'切り口はどこへ？', difficulty:1, folds:[vertical,horizontal],
      // Keep each opening centered; enlarge the triangle and put its tip at 25% of the opening.
      cuts:[cut([[0,12.75],[16.5,17.625],[0,32.25]], '折り目から離れた左の辺')], expectedCuts:4,
      lesson:'折り目から離れた切り口は、上下、そして左右にうつり、4か所に現れます。',
      options:[{skip:[1],label:'左右の2か所',reason:'よこの折り目を開き忘れている'}, {cuts:[cut([[12.75,0],[17.625,16.5],[32.25,0]])],label:'上下の辺に4か所',reason:'たてとよこの対称移動を取り違えている'}, {translate:[1],label:'上下の切り口が同じ向き',reason:'反転せずに平行移動している'}, {kind:'correct'}], answerLabel:'左右の辺に、向きが対称な4つの切り口' },
    ...
    { id:'three-folds', title:'3回の折り返し', difficulty:3, folds:[vertical,horizontal,smallDiagonal],
      // 1.5× opening, 1.45× depth: the corner-position distractor stays separated.
      cuts:[cut([[0,20.5],[10.15,24.25],[0,35.5]], '折り目ではない左の辺')], expectedCuts:8,
      lesson:'折り目から離れた切り口が、斜め・上下・左右の順にうつります。最後は4つの辺に2つずつ、8か所です。',
      options:[{skip:[2],label:'左右の辺に4つ',reason:'斜めの折り返しを忘れている'}, {cuts:[cut([[0,6.5],[10.15,10.25],[0,21.5]])],label:'四すみ寄りの8つ',reason:'3回目の折り目からの距離を取り違えている'}, {translate:[0,1],label:'向きの違う8つ',reason:'位置だけをうつして切り口の向きを反転していない'}, {kind:'correct'}], answerLabel:'4つの辺に2つずつ、8つの切り口' },
